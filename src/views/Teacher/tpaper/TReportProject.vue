          ...
          <a-card :hoverable="true">
            <a-card-meta>
              ...
              <div class="meta-content" slot="description">
                <p>
                  <a-tag v-if="item.projectState == 0" color="blue"
                    >未选择</a-tag
                  >
                  <a-tag v-if="item.projectState == 1" color="red"
                    >已被选待审核</a-tag
                  >
                  <a-tag v-if="item.projectState == 2" color="red"
                    >已被选</a-tag
                  >
                </p>
...
import {
  requestTeacherByUserId,
  requestTeacherByTeacherId
} from "@/api/teacher.js";
export default {
  name: "TProject",
  data() {
  ...
  methods: {
    ...
    //   axios.get("/project/getprojectlistbyteacherid").then((res) => {
