<template>
  <div>
    ...
    <el-breadcrumb separator="/" style="margin-bottom:20px">
      ...
      <el-breadcrumb-item>教师成绩管理</el-breadcrumb-item>
      <el-breadcrumb-item>编辑成绩</el-breadcrumb-item>
    </el-breadcrumb>
...
export default {
  ...
  created() {
    ...
    axios.get('http://175.24.188.37:10086/SCT/findById/' +
        this.ruleForm.sid + '/' +
        this.ruleForm.cid + '/' +
        this.ruleForm.tid + '/' +
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          axios.get("http://175.24.188.37:10086/SCT/updateById/" + sid + '/' + cid + '/' + tid + '/' + term + '/' + grade).then(function (resp) {
            if (resp.data === true) {
              that.$message({
                showClose: true,
                message: '编辑成功',
