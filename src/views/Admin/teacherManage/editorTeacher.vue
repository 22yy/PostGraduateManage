<template>
  <div>
    ...
    <el-breadcrumb separator="/" style="margin-bottom:20px">
      ...
      <el-breadcrumb-item>编辑教师</el-breadcrumb-item>
    </el-breadcrumb>
...
export default {
  ...
  created() {
    ...
    axios.get('http://175.24.188.37:10086/teacher/findById/' + this.ruleForm.tid).then(function (resp) {
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          axios.post("http://175.24.188.37:10086/teacher/updateTeacher", this.ruleForm).then(function (resp) {
            if (resp.data === true) {
              that.$message({
                showClose: true,
                message: '编辑成功',
